//
//  VTXTopSegmentedControl.m
//  VetX
//
//  Created by YulianMobile on 12/1/15.
...
@interface VTXTopSegmentedControl ()
...
@implementation VTXTopSegmentedControl
...
//    upperBorder.backgroundColor = [UIColor colorWithRed:0.416  green:0.416  blue:0.416 alpha:1].CGColor;
...
- (void)commonInit
{
    ...
    _selectionIndicatorHeight = 5.0f;
...
- (void)layoutSubviews
{
    ...
    [[self buttons] enumerateObjectsUsingBlock:^(UIButton *button, NSUInteger idx, BOOL *stop) {
        ...
        if (idx != [self buttons].count-1) {
            UILabel *line = [[UILabel alloc] initWithFrame:CGRectMake(width-0.5, 10, 0.5, height-20)];
...
- (void)setDelegate:(id<VTXSegmentedControlDelegate>)delegate
{
    _delegate = delegate;
...
//        upperBorder.backgroundColor = [UIColor colorWithRed:0.416  green:0.416  blue:0.416 alpha:1];
//        upperBorder.frame = CGRectMake(CGRectGetWidth(button.frame)-1, 6.0f, 1.0f, CGRectGetHeight(button.frame)-12.0f);
//        [button addSubview:upperBorder];
//    }
